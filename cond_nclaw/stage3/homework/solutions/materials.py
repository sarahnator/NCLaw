"""Two conditioned constitutive networks (elastic + plastic) sharing one latent z,
mirroring NCLaw's InvariantFullMeta{Elasticity,Plasticity} (3D).  [given from Stage 2]

rest_correct=False (default, UniPhy convention): plain concat -> equilibrium at z=0.
rest_correct=True: subtract the rest output -> equilibrium for every z."""
import torch
